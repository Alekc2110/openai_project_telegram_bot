...
public class TelegramBotConfiguration {
    ...
    public TelegramBot telegramBot(TelegramBotsApi telegramBotsApi, ChatGptModelStrategy strategy,
                                   TelegramCommandDispatcher telegramCommandDispatcher, TelegramDataHandler voiceHandler) throws TelegramApiException {
        var bot = new TelegramBot(botToken, botName, strategy, telegramCommandDispatcher, voiceHandler);
